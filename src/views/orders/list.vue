<template>
  <view-box>
    ...
    <tab :line-width="2" custom-bar-width="60px" :active-color="barActiveColor" :bar-active-color="barActiveColor" v-model="selectedIndex" style="margin-top: 46px;">
    ...
    <div class="order-panel" v-for="(item, index) in orderList" :key="index">
      ...
      <flexbox :gutter="0">
        ...
        <flexbox-item :span="4" v-if="item.statusCode==='2'">
          <div class="order-last"><x-button mini type="primary">去支付</x-button></div>
        </flexbox-item>
      </flexbox>
    </div>
  </view-box>
...
<script>
  import { ViewBox, XHeader, Tab, TabItem, XButton, Group, Cell, CellBox, Panel, Flexbox, FlexboxItem } from 'vux'
  export default {
    components: {
      ViewBox,
      XHeader,
